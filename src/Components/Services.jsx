  ...
  const services = [
    {
      ...
      description: 'Building end-to-end web solutions using React.js for the frontend and Django/Python for the backend.',
      icon: (
    ...
    },
    {
      ...
      description: 'Creating robust RESTful APIs and integrating third-party services to enhance application functionality.',
      icon: (
        <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              <Motion.div 
                ...
                viewport={{ once: true }}
                className="pt-6">
                <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-md hover:shadow-lg transition-shadow duration-300 h-full">
                  <div className="-mt-6">
